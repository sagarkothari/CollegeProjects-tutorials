...
public class PlayerNames extends Activity implements OnItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Boolean a1=w.getBoolean("sound_pref",true);
		...
		p3=(TextView)findViewById(R.id.textView1);
...
Typeface titleFont = Typeface.createFromAsset(this.getAssets(),"ROBOTOCONDENSED-REGULAR.TTF");
		...
		p1.setTypeface(titleFont);
		p2.setTypeface(titleFont);
		p3.setTypeface(titleFont);
		b.setTypeface(titleFont);
		plr1.setTypeface(titleFont);
		plr2.setTypeface(titleFont);
		//b.setTypeface(titleFont);
		
		//s.setTypeface(titleFont);
